<?php
	...
	$queryUpdate = $enderecoUPDATendereco = '$cpf', telefone = '$telefone', ano_adimissao = '$ano_adimissao', cargo_id = '$cargo_id' WHERE id = '$id'");

	if(mysqli_affected_rows($link) > 0){
		$_SESSION['msg'] = '<p cfornecedorr green-text">Atualização realizada com sucesso!</p>';
		header("Location: ../funcionario/consultas.php");
	}
	elfornecedorSSION['msg'] = '<p class="center red-text">Erro!</p>';
		header("Location: ../funcionario/consultas.php");
	}
