<marquee direction="right" scrolldelay="110">
	<img src="../imagem/bike2.gif" style="width: 50px"/>
</marquee>

<footer class="page-footer" style="background-color: rgb(57, 179, 185); margin-top: -0.7%">
	<div class="container">
		<div class="row">
